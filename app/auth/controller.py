...
api = AuthDto.api #auth namespace
...
class AuthLogin(Resource):
    ...
    @api.expect(auth_login, validate=True) #expect 2 value email and password 
    def post(self):
        """
        User Login
        """
        ...
        return AuthService.login(login_data) #gelen login verisini service kısmındaki fonksiyona gönder gerekeni dönsün.
